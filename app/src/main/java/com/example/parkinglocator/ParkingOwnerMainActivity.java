...
import com.example.parkinglocator.Adapter.ParkingDetailAdapter;
...
public class ParkingOwnerMainActivity extends AppCompatActivity {
                    ...
                    if (text.equals("")) {
                        ...
                        for (ParkingDetail offer : parkingDetailList) {
                            if (offer.getTwoWheeler().toLowerCase().contains(text))
                                ...
                                matchedList.add(offer);
                            else if (offer.getParkingDetailId().toLowerCase().contains(text))
                                matchedList.add(offer);
                            else if (offer.getName().toLowerCase().contains(text))
                                matchedList.add(offer);
                            else if (offer.getFourWheeler().toLowerCase().contains(text))
                                matchedList.add(offer);
                            else if (offer.getEmail().toLowerCase().contains(text))
                                matchedList.add(offer);
                            else if (offer.getAddress().toLowerCase().contains(text))
                                matchedList.add(offer);
                            else if (offer.getLatitude().toLowerCase().contains(text))
                                matchedList.add(offer);
                            else if (offer.getLongitude().toLowerCase().contains(text))
                                matchedList.add(offer);
...
//                    new ItemTouchHelper(itemTouchHelperCallback).attachToRecyclerView(recyclerView);
        ...
        btnAddParkingSlot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ParkingOwnerMainActivity.this, ParkingOwnerAddParkingDetails.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.contactUs) {
            ...
            if (ActivityCompat.checkSelfPermission(ParkingOwnerMainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                //request permission from user if the app hasn't got the required permission
                ActivityCompat.requestPermissions(ParkingOwnerMainActivity.this,
        ...
        if (item.getItemId() == R.id.profile) {
            Intent intent=new Intent(ParkingOwnerMainActivity.this,ParkingOwnerProfileActivity.class);
            startActivity(intent);
